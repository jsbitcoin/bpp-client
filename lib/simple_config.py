...
"""
    ...
    def init_path(self):
        ...
        print_error( "bbp directory", self.path)
    ...
    def read_system_config(self):
        ...
        if os.path.exists(name):
            try:
                ...
                print "cannot parse bbp.conf. please install ConfigParser"
                return
    ...
    def read_user_config(self):
        """Parse and store the user config settings in bbp.conf into user_config[]."""
